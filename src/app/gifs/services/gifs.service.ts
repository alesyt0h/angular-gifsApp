...
export class GifsService {
  ...
  private apiKey      : string = 'cexJDsRKWeTtItVkqsHO1GtboZio1hct';
...
// Normal Fetch Method
//
// fetch('https://api.giphy.com/v1/gifs/search?api_key=cexJDsRKWeTtItVkqsHO1GtboZio1hct&q=putas&limit=10')
//   .then( resp => {
//     resp.json().then(data => {
//       console.log(data)
//     })
...
//      const resp = await fetch('https://api.giphy.com/v1/gifs/search?api_key=cexJDsRKWeTtItVkqsHO1GtboZio1hct&q=putas&limit=10')
